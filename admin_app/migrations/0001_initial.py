    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mamandygy', models.CharField(blank=True, max_length=100, null=True)),
                ('degree', models.CharField(choices=[('bakalavr', 'bakalavr'), ('magistratura', 'magistratura'), ('doktorantura', 'doktorantura'), ('srednee', 'srednee'), ('viswee', 'viswee')], default='bakalavr', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('map', models.FileField(upload_to='uploads/')),
                ('flat1', models.FileField(upload_to='uploads/')),
