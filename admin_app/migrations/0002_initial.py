...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='schedule',
            name='classl',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='admin_app.class'),
        ),
        migrations.AddField(
            model_name='schedule',
            name='classroom',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='admin_app.classrooms'),
        ),
        migrations.AddField(
            model_name='schedule',
            name='classroom2',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='classroom_g2', to='admin_app.classrooms'),
        ),
        migrations.AddField(
            model_name='schedule',
            name='ring',
        ...
        migrations.AddField(
            model_name='photo',
            name='news',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='photos', to='admin_app.news'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='news',
            name='photos1',
            field=models.ManyToManyField(blank=True, related_name='news_photos', to='admin_app.photo'),
        ),
        migrations.AddField(
            model_name='news',
            name='school',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='news', to='admin_app.school'),
        ),
        migrations.AddField(
            model_name='menu',
            name='school',
        ...
        migrations.AddField(
            model_name='lesson',
            name='kruzhok',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lessons', to='admin_app.kruzhok'),
        ),
        migrations.AddField(
            model_name='kruzhok',
            name='school',
        ...
        migrations.AddField(
            model_name='dopurok',
            name='classroom2',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='classroom2', to='admin_app.classrooms'),
        ),
        migrations.AddField(
            model_name='dopurok',
            name='ring',
