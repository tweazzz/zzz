...
class SchoolLessonTime(models.Model):
    school = models.ForeignKey('School', on_delete=models.CASCADE)
    shift = models.CharField(max_length=10, choices=[('morning', 'Morning'), ('afternoon', 'Afternoon')])
...
class ClassGroup(models.Model):
    ...
    language = models.ForeignKey('Nationality', on_delete=models.CASCADE, null=True)
    ...
    def save(self, *args, **kwargs):
        if self.class_name:
            ...
            letters = [s.upper() for s in self.class_name if s.isalpha()]
...
class Schedule(models.Model):
    ...
    classroom2 = models.ForeignKey('Classroom', on_delete=models.CASCADE, null=True, blank=True, related_name='classroom_g2')
...
class DopUrok(models.Model):
    ...
    classroom2 = models.ForeignKey('Classroom', on_delete=models.CASCADE, null=True,blank=True, related_name='classroom2')
...
class Subject(models.Model):
    full_name = models.CharField(max_length=250)
    importance = models.IntegerField(choices=[(i, i) for i in range(1, 12)], null=True, blank=True)
    school = models.ForeignKey('School', on_delete=models.CASCADE, null=True)
